...
%%%
\title{UNF Computer Science Camp 2022 Sangbog}
\author{}
...
\begin{titlepage}
  ...
  \vspace{5cm}
	...
	\vspace{1cm}
	{\scshape\Large UNF Computer Science Camp 2022\par}
...
%%% Kolofon
\thispagestyle{empty}
Sammensat til UNF Computer Science Camp 2022 - csc.unf.dk\\
...
\fancyfoot[LE,RO]{\LFootFont Computer Science Camp 2022}
\ifSongEject
...
\newpage %Hack for at indholdfortegnelsen har det korrekte side nummer
\input{songs/texe_i_nat.tex}
\newpage %Hack for at indholdfortegnelsen har det korrekte side nummer
\input{songs/lav_plagiat.tex}
\newpage %Hack for at indholdfortegnelsen har det korrekte side nummer
\input{songs/spas_i_waders.tex}
\input{songs/selektionssangen.tex}
%\input{songs/prins_henri.tex}
...
\input{songs/taal_daj_paa_campen.tex}
\input{songs/steffensangen.tex}
\input{songs/koder_hele_dagen_lang.tex}
...
\input{songs/et_helt_nyt_sprog.tex}
\newpage %Hack for at indholdfortegnelsen har det korrekte side nummer
\input{songs/vi_skal_kode_i_c.tex}
\input{songs/i_morgen_er_verden_vor.tex}
\input{songs/DAT62.tex}
\input{songs/null.tex}
\newpage %Hack for at indholdfortegnelsen har det korrekte side nummer
\input{songs/send_mig_dit_password.tex}
\newpage %Hack for at indholdfortegnelsen har det korrekte side nummer
\input{songs/saa_spiller_vi_spil.tex}
\newpage %Hack for at indholdfortegnelsen har det korrekte side nummer
\input{songs/jeg_kender_et_sprog.tex}
...
%\input{songs/witch_doctor.tex}
%Pokémon\\
%I Want It What Way\\
%Jutlandia\\
%YMCA
%\input{songs/kaere_linedanser.tex}
\newpage %Hack for at indholdfortegnelsen har det korrekte side nummer
